...
export function HeroSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden pt-32 pb-24 sm:pt-40 sm:pb-32">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(124,58,237,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(124,58,237,0.05)_1px,transparent_1px)] bg-size-[44px_44px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/4 h-150 w-225 rounded-full bg-violet-600/10 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-48 top-1/4 h-100 w-125 rounded-full bg-indigo-600/8 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="flex justify-center mb-8">
          <span className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/8 px-4 py-1.5 text-xs font-medium text-violet-300 ring-1 ring-inset ring-violet-500/10">
            ...
            {interpolate(t.hero.badge, { version: DOWNLOAD_CONFIG.version })}
          </span>
        </div>
